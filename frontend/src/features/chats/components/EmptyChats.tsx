...
export default function EmptyChats() {
    return (
        <div className="flex-1 flex flex-col items-center justify-center p-6 text-center">
            ...
            <button className="px-5 py-2 rounded-xl border border-border text-brand-500 text-sm font-medium hover:bg-surface-hover hover:border-border-hover transition-all">
                Start a new chat
            </button>
        </div>
    );

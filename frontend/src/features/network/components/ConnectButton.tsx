...
export default function ConnectButton({ recieverId }: { recieverId: number }) {
    ...
    return (
        <button
            className="flex touch-manipulation items-center gap-2 rounded-lg bg-brand-600 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-brand-500 active:bg-brand-700"
